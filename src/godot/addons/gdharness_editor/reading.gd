...
# directory and has to hold everything it uses. Reaching into the runtime addon instead would tie an
# editor tool to a directory that ships inside exported games.
#
