        ...
        messages: [
          {
            ...
            content: {
              ...
              text: [
                ...
                '',
                'Execute in order:',
                '1) Call project_info to confirm project metadata and main scene.',
                `2) Call scene_create with scenePath='${scenePath}' and rootNodeType='${rootNodeType}'.`,
                '3) Add core nodes with scene_node op=add; every add saves the scene.',
                '4) Create or modify the attached script with script_edit, using typed exports for tunable values.',
                '5) Run editor_run on the same project path, collect editor_output, and fix top blocking errors.',
        ...
        messages: [
          {
            ...
            content: {
              ...
              text: [
                ...
                '',
                'Workflow:',
                '1) Call editor_run for the target project and reproduce once.',
                '2) Collect logs with editor_output; isolate the first root-cause error.',
                '3) Use script_diagnostics and script_info op=hover on the implicated script(s) before editing.',
                '4) Apply the smallest fix with script_edit op=modify or the scene and resource tools.',
                '5) Re-run editor_run and confirm the original error excerpt no longer appears.',
